...
AVAILABLE_LOCALES = ["ar", "be-TARASK", "br", "bs", "ca", "de", "eo", "el", "en", "es-419", "fi", "fr", "gl", "ia", "id", "ja", "ko", "lb", "mk", "nb", "nl", "pms", "ps", "pl", "pt-BR", "pt-PT", "ru", "te", "tl"] #I18n.backend.available_locales.map { |l| l.to_s }
