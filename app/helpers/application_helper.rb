...
module ApplicationHelper
  ...
  def markdown(txt)
    txt = sanitize(txt.to_s, :tags => %w[b h1 h2 h3 i img sup sub strong br hr ul li ol em table pre code blockquote a span font strike], :attributes => %w[href src title alt style])
